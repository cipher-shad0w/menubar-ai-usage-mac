...
SUPPORTED_BROWSERS = [
    ...
    ("comet", browser_cookie3.chrome),  # Comet uses Chrome-compatible cookie storage
]
...
def main() -> None:
    ...
    try:
        ...
        if args.waybar:
            ...
            # Output structured error for macOS app with browser list
            error_data = {
                "error": str(e),
                "supported_browsers": [b[0] for b in SUPPORTED_BROWSERS]
            }
            # Print JSON on one line, then the human-readable error
